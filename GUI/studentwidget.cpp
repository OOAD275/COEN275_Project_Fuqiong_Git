...
void StudentWidget::initToolBar()
{
    ...
    QIcon Profile(":images/profile.png"); QString ProfileText = "Profile";
    QIcon Search(":images/search.png"); QString SearchText = "Search";
    QIcon favorite(":images/book.png"); QString favoriteText = "My Books";
    QIcon History( ":images/history.png"); QString HistoryText = "History";
    QIcon Return(":images/return.png"); QString ReturnText = "Return";
    QIcon LogOut(":images/logout.png"); QString LogOutText = "Log Out";
    QIcon Pay(":images/pay.jpg"); QString PayText = "Pay";
